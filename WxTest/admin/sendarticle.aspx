<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sendarticle.aspx.cs" Inherits="WxTest.admin.sendarticle" %>
        ...
        $(document).ready(function () {
            $("#send-btn").click(function () {
                ...
                $.ajax({
                    ...
                    data: { "pAction": "sendarticle", "text": $("#Select1").val(), "openid": openid },
                    dataType: "json",
                    beforeSend: function () {
