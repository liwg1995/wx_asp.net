<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sendtext.aspx.cs" Inherits="WxTest.admin.sendtext" %>
        ...
        $(document).ready(function () {
            $("#send-btn").click(function () {
                ...
                $.ajax({
                    ...
                    data: { "pAction": "sendtext", "text": $("#messcon").val(), "openid": openid },
                    dataType: "json",
                    beforeSend: function () {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="messcon" runat="server" CssClass="inputtext" Width="500px" TextMode="MultiLine" Height="50"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;
