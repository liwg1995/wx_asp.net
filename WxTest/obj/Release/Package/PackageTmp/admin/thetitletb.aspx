<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thetitletb.aspx.cs" Inherits="WxTest.admin.thetitletb" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="font-family: 微软雅黑;">
                                    <a href='thetitle.aspx?id=<%#Eval("Id")%>' style="font-family: 微软雅黑;">修改</a>
