<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="materialtb.aspx.cs" Inherits="WxTest.admin.materialtb" %>
                ...
                <table class="niunantab">
                    <tbody>
                        <tr>
                            ...
                            <th style="font-family: 微软雅黑;">附件
                            </th>
                            <th style="font-family: 微软雅黑;">上传时间
                            </th>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="font-family: 微软雅黑;">
                                        <a href="../uploads/<%#Eval("materialfile")%>" /><%#Eval("materialfile")%></a>
                                    </td>
                                    <td style="font-family: 微软雅黑;">
                                        <%#Eval("materialtime")%>
                                    </td>
                                    ...
                                    <td style="font-family: 微软雅黑;">
                                        <a href='material.aspx?id=<%#Eval("Id")%>' style="font-family: 微软雅黑;">修改</a>
