<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="themesstb.aspx.cs" Inherits="WxTest.admin.themesstb" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="font-family: 微软雅黑;">
                                    <a href='themess.aspx?id=<%#Eval("Id")%>' style="font-family: 微软雅黑;">修改</a>
