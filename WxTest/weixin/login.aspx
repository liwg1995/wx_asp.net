<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="WxTest.weixin.login" %>
        ...
        <div>
            ...
            <div id="boxForm">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="clearfix">
                        <asp:Button ID="Button1" runat="server" Text="登录" CssClass="btn btn-success" OnClick="Button1_Click" /><span id="lblInfo" runat="server" style="color: Red; font-size: 12px;"></span>
                    </div>
